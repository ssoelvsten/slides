...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[scale=2]
      ...
      \onslide<2-> {
        \draw[-latex, thick] (A) edge node[above] {$f_M$} (B);
      }
      \onslide<3-> {
        \draw[-latex, thick] (A) edge[bend right=30] node[below] {$g_M$} (B);
      }
    \end{tikzpicture}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[scale=2]
      ...
      \onslide<2-> {
        \draw[-latex, thick] (A) edge node[above] {$f_M$} (C);
      }
      \onslide<3-> {
        \draw[-latex, thick] (C) edge node[above, pos=.1] {*} node[above] {$f_M$} (B);
      }
      \onslide<4-> {
        \draw[-latex, thick] (A) edge[bend right=30] node[below] {$g_M$} (B);
      }
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[scale=2]
      ...
      \onslide<2-> {
        ...
        \draw[-latex, thick] (A) edge[bend left] node[above] {$f_M$} (B);
      }
      \onslide<3-> {
      ...
      \onslide<4-> {
        ...
        \draw[-latex, thick] (B) edge[bend left] node[above] {$f_M$} (C);
      }
      \onslide<5-> {
      ...
      \onslide<6-> {
        ...
        \draw[-latex, thick] (C) edge[bend left] node[above] {$f_M$} (D);
      }
      \onslide<7-> {
      ...
      \onslide<8-> {
        ...
        \draw[-latex, thick] (Y) edge[bend left] node[above] {$f_M$} (Z);
      }
      \onslide<9-> {
        \node at (5, -1) (Zf) {$f_M()$};
