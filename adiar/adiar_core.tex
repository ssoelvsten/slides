...
\institute{\includegraphics[width=0.2\linewidth]{../au_resources/aulogo_uk_var2_black.eps}}
...
\begin{frame}
  \begin{figure}
    ...
    \begin{subfigure}[b]{0.48\linewidth}
      ...
      \begin{tikzpicture}
        \input{pgf/buddy_cache_time.tex}
      \end{tikzpicture}

      \label{fig:sylvan:misses}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.48\linewidth}
      \centering
      ...
      \begin{tikzpicture}
        \input{pgf/buddy_cache_misses.tex}
      \end{tikzpicture}

      \label{fig:sylvan:time per node}
    \end{subfigure}
...
\begin{frame}
  \begin{figure}
    ...
    \begin{tikzpicture}
      \input{pgf/buddy_cache_swap.tex}
    \end{tikzpicture}
...
\begin{frame}
  \input{anim/levelized_priority_queue.tex}
\end{frame}
