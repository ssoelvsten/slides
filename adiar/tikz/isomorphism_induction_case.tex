...
\onslide<2->{
  \node[black, right =0.8cm of g1] (g1_less) {\small $<$};
}
...
\onslide<2->{
  \node[black, right =0.8cm of g2] (g2_less) {\small $<$};
}
...
\onslide<2->{
  \node[black, right =0.8cm of g3] (g3_less) {\small $<$};
}

\node[right=1.5cm of g3] (g_dots) {$\dots$};

\onslide<2->{
  \node[black, right =0.2cm of g_dots] (fdots_less) {\small $<$};
}
